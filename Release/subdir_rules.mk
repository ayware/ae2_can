...
ADC_Function.obj: ../ADC_Function.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"D:/CodeComposer/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.6.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me -O2 --include_path="D:/CodeComposer/WorkSpace/Ae2Can" --include_path="D:/CodeComposer/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.6.LTS/include" --define=ccs="ccs" --define=PART_TM4C1231D5PM --gcc --diag_warning=225 --diag_wrap=off --display_error_number --abi=eabi --preproc_with_compile --preproc_dependency="ADC_Function.d_raw" $(GEN_OPTS__FLAG) "$<"
